...
(defvar *target-trials* 60) ; number of target trials
(defvar *non-target-trials* 60) ; number of non-target trials
...
(chunk-type numberfact string parity target)
...
(add-dm
	...
	(press-on-even isa srmapping stimulus "even"  hand left)
	(press-on-odd isa srmapping stimulus "odd" hand right)
	(withhold-on-3 isa srmapping stimulus "3" hand nil)
	; number facts, string value and parity (classification even/odd) and target information
	(n1 isa numberfact string "1" parity "odd" target t)
	(n2 isa numberfact string "2" parity "even" target t)
	(n3 isa numberfact string "3" parity "odd" target f)
	(n4 isa numberfact string "4" parity "even" target t)
	(n5 isa numberfact string "5" parity "odd" target t)
	(n6 isa numberfact string "6" parity "even" target t)
	(n7 isa numberfact string "7" parity "odd" target t)
	(n8 isa numberfact string "8" parity "even" target t)
	(n9 isa numberfact string "9" parity "odd" target t)
	...
	(get-parity isa subgoal step get-parity goal attend)
...
(set-base-levels
	(attend					10000	-10000)
	(wander					10000	-10000)
	(press-on-even			10000	-10000)
	(press-on-odd			10000	-10000)
...
(p retrieve-response-non-target
	=goal>
		isa			subgoal
		step		get-response
	=retrieval>
